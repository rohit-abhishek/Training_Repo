# Smarter version of pricer_service.py. In pricer_service, everytime pricer method is called. The image needs to be rebuilt
# here all setups are done during modal.enter() decorator within Pricer class. 
...
class Pricer:
    ...
    # build the image before so that it does not spend time in building the iamge everytime we call price method.
    @modal.enter()
    def setup(self):
        import torch
