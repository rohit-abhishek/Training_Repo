""" 
This is clone of program particle.py. And this is 9th program in this series making use of line_profiler utility. 

After performing benchmark run using pytest-benchmark utility & QCachegrind - we can easily conclude the program is taking more time 
when executing evolve function. 

This program will use line_profiler utility to understand where in the evolve function; CPU is taking more time. 
this will require to include a @profile decorator on top of evolve function. 

To run this program we need kernprof.py 
    $ kernprof -l -v particle_line_profiler.py 

This will create lprof extension file

To run this program in IPython shell we can use 
%load_ext line_profiler 
%lprun -f ParticleSimulator.evolve benchmark()

-l indicates to use line_profiler 
-v indicates to immediately print results on screen 


The output of this program may look like 
...
==============================================================
    ...
    Line#: is the line number executed 
    Hits: is number of times line was executed 
    Time: is execution time in microseconds 
    Per Hits: Time/hits 
    % Time: Fraction of total time spent executing that line 
